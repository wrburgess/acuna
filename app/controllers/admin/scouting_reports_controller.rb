class Admin::ScoutingReportsController < AdminController
  ...
  def index
    ...
    @q = controller_class.includes(:scout, :player).ransack(params[:q])
  ...
  def collection_export_xlsx
    ...
    sql = %(
        ...
        FROM
          scouting_reports
        WHERE
          scouting_reports.archived_at IS NULL
        ORDER BY
          scouting_reports.created_at ASC
      )
  ...
  def member_export_xlsx
    ...
    sql = %(
        ...
        FROM
          scouting_reports
        WHERE
          scouting_reports.id = #{instance.id}
        ORDER BY
          scouting_reports.created_at ASC
      )
